...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div>
                    <a href="{{ url('content') }}" class="btn btn-primary mb-3">Content List</a>
                                ...
                                <div class="cm-content-body  publish-content form excerpt">
                                    <div class="card-body py-3">
                                        ...
                                        <ul class="d-flex align-items-center mb-2">
                                            ...
                                            <li><a href="javascript:void(0);" class="ms-2">Status:</a></li>
                                            <li><strong><a href="javascript:void(0);" class="mx-2">Public</a></strong>
                                            </li>
                                            <li><a href="javascript:void(0);" class="accordion accordion-primary"
                                                ...
                                                <div class="basic-form">
                                                    <form>
                                                        <div class="mb-3 mb-0">
                                                            ...
                                                            <div class="radio">
                                                                <label class="form-check-label"><input type="radio"
                                                                        name="optradio" class="form-check-input"> Password
                                                                    Protected</label>
                                                            </div>
