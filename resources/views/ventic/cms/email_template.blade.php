		...
		<div class="col-xl-12">
				...
				<div class="cm-content-body  form excerpt">
					<div class="card-body pb-3">
						<div class="row">
							...
							<div class="col-xl-3 col-sm-6 ">
								<select class="form-control mb-3 default-select dashboard-select-2 h-auto wide">
			...
			<div class="mb-5">
				<ul class="d-flex align-items-center">
					<li><a href="{{ url('add-email') }}" class="btn btn-primary">New Email Template</a></li>
				</ul>
			</div>
			<div class="filter cm-content-box box-primary">
				<div class="content-title SlideToolHeader">
				...
				<div class="cm-content-body  form excerpt">
					<div class="card-body py-3">
						<div class="table-responsive">
							<table class="table table-striped table-condensed flip-content ">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="javascript:void(0);" class=" btn btn-primary btn-sm content-icon m-0"><i class="fa-solid fa-check"></i></a></td>
										<td>04 Feb, 2024</td>
										<td class="text-end">
											<a href="javascript:void(0);" class="btn btn-warning btn-sm content-icon">
												 <i class="fa-solid fa-pen-to-square"></i>
							...
							<div class="d-flex align-items-center justify-content-sm-between justify-content-center flex-wrap py-3">
								<small>Page 1 of 4, showing 2 records out of 8 total, starting on record 1, ending on 2</small>
