		...
		<div class="col-xl-12">
			<div class="filter cm-content-box box-primary">
				...
				<div class="cm-content-body  form excerpt">
					<div class="card-body">
						<div class="row align-items-center p-xl-3 p-0">
				...
				<div class="col-xl-8">
					<div class="filter cm-content-box box-primary">
						<div class="content-title d-sm-flex d-block flex-wrap">
							<div class="cpa d-sm-flex d-block align-items-center flex-wrap">
								<span class="pe-2 d-inline-block mb-sm-0 mb-2">Menu Name</span>
												  ...
												  <div class="accordion-body">
														<div class="row">
															...
															<div class="d-flex align-items-center">
																<a class="text-hover" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																
																<a class="text-hover" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
																Cancel
															  </a>
															</div>
														</div>												
												...
												<div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<div class="row">
															...
															<div class="d-flex align-items-center">
																<a class="text-hover" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																<a class="text-hover" href="javascript:void(0);"  data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
																Cancel
															  </a>
															</div>
														</div>												
												...
												<div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<div class="row">
															...
															<div class="d-flex align-items-center">
																<a class="text-hover" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																<a class="text-hover" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
																Cancel
															  </a>
															</div>
														</div>												
												...
												<div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<div class="row">
															...
															<div class="d-flex align-items-center">
																<a class="text-hover" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																<a class="text-hover" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
																Cancel
															  </a>
															</div>
														</div>												
												...
												<div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
													<div class="accordion-body">
														<div class="row">
															...
															<div class="d-flex align-items-center">
																<a class="text-hover" href="javascript:void(0);">Remove</a><span class="mx-2">|</span>
																<a class="text-hover" href="javascript:void(0);"   data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
																Cancel
															  </a>
															</div>
														</div>												
						...
						<div class="filter cm-content-box box-primary style-1 mb-0 border-0">
							<div class="content-title AccordianSliderToggle">
								<div class="cpa">
									Delete Menu
								</div>
