					...
					<div class="card event-bx">
						...
						<div class="card-body dz-scroll loadmore-content pt-0" id="EventListContent">
							<div class="media event-list pb-3 border-bottom mb-3">
								<div class="image">	
									<img src="{{ asset('images/card/Untitled-15.jpg') }}" alt="">
							...
							<div class="media event-list pb-3 border-bottom mb-3">
								<div class="image">	
									<img src="{{ asset('images/card/Untitled-16.jpg') }}" alt="">
							...
							<div class="media event-list pb-3 border-bottom mb-3">
								<div class="image">	
									<img src="{{ asset('images/card/Untitled-17.jpg') }}" alt="">
									<i class="fa fa-music image-icon"></i>
						...
						<div class="card-footer text-center pt-0 border-0">
							<a href="javascript:void(0);" class="btn btn-secondary btn-lg  text-white dz-load-more" id="EventList" rel="{{ route('ajax_event_list') }}">Load More</a>
						</div>	
					</div>
				</div>
				<div class="col-xl-6 col-xxl-12">
					<div class="card latest-sales-bx">
						...
						<div class="card-body pb-0 dz-scroll loadmore-content pt-0" id="LatestSalesContent">
							<div class="media pb-3 border-bottom mb-3 align-items-center">
								<div class="media-image me-2">
									<img src="{{ asset('images/contacts/pic1.jpg') }}" alt="">
								</div>
								<div class="media-body">
							...
							<div class="media pb-3 border-bottom mb-3 align-items-center">
								<div class="media-image me-2">
									<img src="{{ asset('images/contacts/pic2.jpg') }}" alt="">
								</div>
								<div class="media-body">
							...
							<div class="media pb-3 border-bottom mb-3 align-items-center">
								<div class="media-image me-2">
									<img src="{{ asset('images/contacts/pic3.jpg') }}" alt="">
								</div>
								<div class="media-body">
						...
						<div class="card-footer style-1 border-0 px-0">
							<a href="javascript:void();" class="dz-load-more fa fa-long-arrow-down text-secondary" id="LatestSales" rel="{{ route('ajax_latest_sales') }}"></a>
						</div>
					</div>
				</div>
				<div class="col-xl-6 col-xxl-12">
				...
				<div class="col-xl-12">
					<div class="card">
						...
						<div class="card-body pb-0 loadmore-content height450 dz-scroll" id="UpcomingEventContent">
							<div class="media mb-5 align-items-center event-list">
								...
								<div class="media-body px-0">
									<h6 class="mt-0 mb-3 fs-14"><a class="text-black" href="{{ url('event') }}">Live Concert Choir Charity Event 2020</a></h6>
						...
						<div class="card-footer pt-0 border-0">
							<a href="javascript:void(0);" class="btn btn-secondary btn-block text-white dz-load-more" id="UpcomingEvent" rel="{{ route('ajax_upcoming_event') }}">Load More</a>
						</div>
					</div>
				</div>
			</div>	
