					...
					<div class="card">
						<div class="card-body">
							<div class="profile-blog">
								...
								<img src="{{ asset('images/profile/1.jpg') }}" alt="" class="img-fluid mt-4 rounded mb-4 w-100">
			...
			<div class="card h-auto">
				<div class="card-body">
					<div class="post-details">
						...
						<img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid rounded mb-3 w-100">
