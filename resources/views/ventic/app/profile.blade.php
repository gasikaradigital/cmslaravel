					...
					<div class="card">
						<div class="card-body">
							<div class="profile-blog">
								<h4 class="text-primary card-title d-inline">Today Highlights</h4>
								<img src="{{ asset('images/profile/1.jpg') }}" alt="" class="img-fluid  rounded mt-4 mb-4 w-100">
							...
							<div class="profile-news">
								...
								<div class="media pt-3 pb-3">
									...
									<div class="media-body">
										<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Innovations in Event Ticketing</a></h5>
								...
								<div class="media pt-3 pb-3">
									...
									<div class="media-body">
										<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Getting More for Your Money</a></h5>
										<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
									</div>
								</div>
								<div class="media pt-3 pb-3">
									...
									<div class="media-body">
										<h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Your Ultimate Guide to Event Tickets</a></h5>
										<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
									</div>
								</div>
							</div>
								...
								<div id="my-posts" class="tab-pane fade active show">
									<div class="my-post-content pt-3">
											...
											<div class="modal fade" id="linkModal">
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<a class="btn-social facebook" href="javascript:void(0)"><i class="fa-brands fa-facebook-f"></i></a>
															<a class="btn-social google-plus" href="javascript:void(0)"><i class="fa-brands fa-google-plus-g"></i></a>
															<a class="btn-social linkedin" href="javascript:void(0)" ><i class="fa-brands fa-linkedin"></i></a>
															<a class="btn-social instagram" href="javascript:void(0)"><i class="fa-brands fa-instagram"></i></a>
															<a class="btn-social twitter" href="javascript:void(0)"><i class="fa-brands fa-twitter"></i></a>
															<a class="btn-social youtube" href="javascript:void(0)"><i class="fa-brands fa-youtube"></i></a>
															<a class="btn-social whatsapp" href="javascript:void(0)"><i class="fa-brands fa-whatsapp"></i></a>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															 ...
															 <a class="btn btn-primary rounded" href="javascript:void(0)">Post</a>																		 
														</div>
													</div>
												</div>
											</div>
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											<img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid rounded w-100">
											<a class="post-title" href="{{ url('post-details') }}"><h3 class="text-black">Navigating the World of Live Entertainment</h3></a>
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											<img src="{{ asset('images/profile/9.jpg') }}" alt="" class="img-fluid rounded w-100">
											<a class="post-title" href="{{ url('post-details') }}"><h3 class="text-black">How to Score the Best Seats in the House</h3></a>
											<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
												of spare which enjoy whole heart.</p>
											<button class="btn btn-primary me-2"><span class="me-2"><i
														class="fa fa-heart"></i></span>Like</button>
										...
										<div class="profile-uoloaded-post pb-3">
											<img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid rounded w-100">
											<a class="post-title" href="{{ url('post-details') }}"><h3 class="text-black">Stories from the World of Events</h3></a>
											<p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
												of spare which enjoy whole heart.</p>
											<button class="btn btn-primary me-2"><span class="me-2"><i
														class="fa fa-heart"></i></span>Like</button>
