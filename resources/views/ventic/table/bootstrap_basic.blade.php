                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><div class="d-flex align-items-center"><img src="{{ asset('images/avatar/1.jpg') }}" class="rounded-lg me-2" width="24" alt=""> <span class="w-space-no">Jackson</span></div></td>
                                ...
                                <tr>
                                    ...
                                    <td><div class="d-flex align-items-center"><img src="{{ asset('images/avatar/2.jpg') }}" class="rounded-lg me-2" width="24" alt=""> <span class="w-space-no">Sunny</span></div></td>
                                ...
                                <tr>
                                    ...
                                    <td><div class="d-flex align-items-center"><img src="{{ asset('images/avatar/3.jpg') }}" class="rounded-lg me-2" width="24" alt=""> <span class="w-space-no">Bobby</span></div></td>
                                    <td>hello@example.com	</td>
                                    <td>01 August 2023</td>
